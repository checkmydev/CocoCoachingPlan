...
export const budgetsData: BudgetLine[] = [
  ...
  { id: '8', centre: 'Gand', project: 'Aide aux migrants', category: 'RH', allocated: 110000, spent: 78000 },
...
export const projects = ['Tous', 'Aide alimentaire', "Hébergement d'urgence", 'Formation secouristes', 'Aide aux migrants']
