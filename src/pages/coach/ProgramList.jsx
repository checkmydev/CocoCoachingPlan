  ...
  return (
    <div className="p-6">
      ...
      {mine.length === 0 && shared.length === 0 && (
        <p className="text-gray-400">Aucun programme. Créez-en un !</p>
      )}

      {mine.length > 0 && (
        <section className="mb-8">
          <h2 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">Mes programmes</h2>
